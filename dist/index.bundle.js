...
/***/ function(module, exports, __webpack_require__) {
	...
	var react_dom_1 = __webpack_require__(43);
	var game_tsx_1 = __webpack_require__(44);
	var redux_1 = __webpack_require__(52);
	var react_redux_1 = __webpack_require__(99);
	var redux_thunk_1 = __webpack_require__(108);
	var reducers_ts_1 = __webpack_require__(45);
	var react_i18next_1 = __webpack_require__(94);
	var i18n_ts_1 = __webpack_require__(109);
	react_dom_1.render(React.createElement(
	    react_redux_1.Provider,
	    { store: redux_1.createStore(reducers_ts_1.default, redux_1.applyMiddleware(redux_thunk_1.default)) },
	    React.createElement(
	        react_i18next_1.I18nextProvider,
	        { i18n: i18n_ts_1.default },
	        React.createElement(game_tsx_1.default, null)
	    )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(42);
	var reducers_ts_1 = __webpack_require__(45);
	var constants_ts_1 = __webpack_require__(51);
	var actions_ts_1 = __webpack_require__(66);
	var ReactModal = __webpack_require__(67);
	var tile_ts_1 = __webpack_require__(46);
	var keyboardJS = __webpack_require__(87);
	...
	var Game = function (_React$Component) {
	    ...
	    function Game(props) {
	        ...
	        _this.tileOnClick = function (ev) {
	            var el = ev.currentTarget,
	                x = parseInt(el.getAttribute('data-x')),
	                y = parseInt(el.getAttribute('data-y'));
	            _this.props.lookAt(x, y);
	        };
	        _this.tileOnMouseEnter = function (ev) {
	            var el = ev.currentTarget,
	                x = parseInt(el.getAttribute('data-x')),
	                y = parseInt(el.getAttribute('data-y'));
	            _this.setState({ mouseEnteredTilePos: [x, y] });
	        };
	        _this.tileOnMouseLeave = function (ev) {
	            _this.setState({ mouseEnteredTilePos: [-1, -1] });
	        };
	        _this.state = {
	    ...
	    _createClass(Game, [{
	        ...
	        value: function componentDidMount() {
	            ...
	            this.loopingTimer = setInterval(this.props.onFrame, 1000 / constants_ts_1.FRAME_IN_SECOND);
	            keyboardJS.bind('up', function (ev) {
	                return _this2.props.onKeyPressed('up');
	            });
	            keyboardJS.bind('down', function (ev) {
	                return _this2.props.onKeyPressed('down');
	            });
	            keyboardJS.bind('left', function (ev) {
	                return _this2.props.onKeyPressed('left');
	            });
	            keyboardJS.bind('right', function (ev) {
	                return _this2.props.onKeyPressed('right');
	            });
	        }
	    }, {
	        ...
	        value: function render() {
	            ...
	            var onStartGameBtnClick = _props.onStartGameBtnClick;

	            var _props$mapCameraOffse = _slicedToArray(_props.mapCameraOffset, 2);

	            var coX = _props$mapCameraOffse[0];
	            var coY = _props$mapCameraOffse[1];

	            var _state$mouseEnteredTi = _slicedToArray(this.state.mouseEnteredTilePos, 2);

	            var hX = _state$mouseEnteredTi[0];
	            var hY = _state$mouseEnteredTi[1];var hoverTile = hX == -1 || hY == -1 ? null : tiles[hX][hY];
	            var PC_SCREEN = window.innerHeight < window.innerWidth;
	            return React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        ...
	                        React.createElement(
	                            'div',
	                            { className: 'row' },
	                            tiles.slice(coX, coX + constants_ts_1.CAMERA_SIZE).map(function (col, cx) {
	                                return col.slice(coY, coY + constants_ts_1.CAMERA_SIZE).map(function (t, cy) {
	                                    return React.createElement(
	                                        'div',
	                                        { className: 'tile', style: {
	                                                width: constants_ts_1.FINAL_TILE_EDGE_LENGTH,
	                                                height: constants_ts_1.FINAL_TILE_EDGE_LENGTH,
	                                                backgroundColor: _this3.state.showGrayLevel ? t.getGrayLevelColor() : t.getTileColor()
	                                            }, 'data-x': coX + cx, 'data-y': coY + cy, onClick: _this3.tileOnClick, onMouseEnter: _this3.tileOnMouseEnter, onMouseLeave: _this3.tileOnMouseLeave },
	                                        '︎ ︎'
	                                    );
	                                });
	                            })
	                    ...
	                    React.createElement(
	                        'div',
	                        { className: 'operationPanel' },
	                        React.createElement('input', { type: 'checkbox', checked: this.state.showGrayLevel, onClick: function onClick(ev) {
	                                return _this3.setState({ showGrayLevel: ev.currentTarget.checked });
	                            } }),
	                        hoverTile == null ? null : React.createElement(
	                            'ul',
	                            null,
	                            React.createElement(
	                                'li',
	                            ...
	                            React.createElement(
	                                ...
	                                null,
	                                'HeightLevel: ',
	                                hoverTile.altitudePos.toFixed(3)
	                            ),
	                            React.createElement(
	                                'li',
	                                null,
	                            ...
	                            React.createElement(
	                                ...
	                                null,
	                                'TileType: ',
	                                tile_ts_1.TileTypeEnum[hoverTile.getTileType()]
	                            )
	                        ),
	                        React.createElement(
	                            'ul',
	                ...
	                React.createElement(
	                    ReactModal,
	                    { isOpen: gameState === reducers_ts_1.GameState.Welcome, style: customStyles },
	                    React.createElement(
	                        'button',
	...
	var react_i18next_1 = __webpack_require__(94);
	var TranslatedGame = react_i18next_1.translate()(Game);
	var mapStateToProps = function mapStateToProps(state) {
	    return {
	        ...
	        msgs: state.msgs,
	        tiles: state.tiles,
	        mapCameraOffset: state.mapCameraOffset
	    };
	};
	var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
	    return {
	        onStartGameBtnClick: function onStartGameBtnClick() {
	            dispatch(actions_ts_1.START_GAME_ACTION);
	        },
	        onFrame: function onFrame() {
	            dispatch(actions_ts_1.ON_FRAME_ACTION);
	        },
	        onKeyPressed: function onKeyPressed(key) {
	            return dispatch(actions_ts_1.onKeyPressed(key));
	        },
	        lookAt: function lookAt(x, y) {
	            return dispatch(actions_ts_1.lookAt(x, y));
	        }
	    };
	};
	var react_redux_1 = __webpack_require__(99);
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = react_redux_1.connect(mapStateToProps, mapDispatchToProps)(TranslatedGame);
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (GameState) {
	    ...
	    GameState[GameState["PauseDialog"] = 2] = "PauseDialog";
	    GameState[GameState["SaveLoadDialog"] = 3] = "SaveLoadDialog";
	})(exports.GameState || (exports.GameState = {}));
	var GameState = exports.GameState;
	var gameState = function gameState() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? GameState.Welcome : arguments[0];
	...
	var mapCameraOffset = function mapCameraOffset() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? [0, 0] : arguments[0];
	    var action = arguments[1];
	...
	var selectedTilePos = function selectedTilePos(state, action) {};
	var tiles = function tiles() {
	    ...
	    switch (action.type) {
	        case 'START_GAME':
	            return tile_ts_1.default.createWorld(constants_ts_1.MAP_EDGE_LENGTH);
	        default:
	            return state;
	    }
	};
	var msgs = function msgs() {
	    var state = arguments.length <= 0 || arguments[0] === undefined ? [] : arguments[0];
	    var action = arguments[1];
	...
	var time = function time() {
	    ...
	    switch (action.type) {
	        case 'ON_FRAME':
	            return state + 1000 / constants_ts_1.FRAME_IN_SECOND;
	        case 'START_GAME':
	            return 0;
	        default:
	            return state;
	...
	var redux_1 = __webpack_require__(52);
	var reducer = redux_1.combineReducers({ gameState: gameState, mapCameraOffset: mapCameraOffset, tiles: tiles, msgs: msgs, person: person, time: time });
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	(function (TileTypeEnum) {
	    TileTypeEnum[TileTypeEnum["Sea"] = 0] = "Sea";
	    TileTypeEnum[TileTypeEnum["SubtropicalDesert"] = 1] = "SubtropicalDesert";
	    TileTypeEnum[TileTypeEnum["Grassland"] = 2] = "Grassland";
	    TileTypeEnum[TileTypeEnum["TropicalSeasonalForest"] = 3] = "TropicalSeasonalForest";
	    TileTypeEnum[TileTypeEnum["TropicalRainForest"] = 4] = "TropicalRainForest";
	    TileTypeEnum[TileTypeEnum["TemperateDesert"] = 5] = "TemperateDesert";
	    TileTypeEnum[TileTypeEnum["TemperateDeciduousForest"] = 6] = "TemperateDeciduousForest";
	    TileTypeEnum[TileTypeEnum["TemperateRainForest"] = 7] = "TemperateRainForest";
	    TileTypeEnum[TileTypeEnum["Shrubland"] = 8] = "Shrubland";
	    TileTypeEnum[TileTypeEnum["Taiga"] = 9] = "Taiga";
	    TileTypeEnum[TileTypeEnum["Scorched"] = 10] = "Scorched";
	    TileTypeEnum[TileTypeEnum["Bare"] = 11] = "Bare";
	    TileTypeEnum[TileTypeEnum["Tundra"] = 12] = "Tundra";
	    TileTypeEnum[TileTypeEnum["Snow"] = 13] = "Snow";
	    TileTypeEnum[TileTypeEnum["Beach"] = 14] = "Beach";
	    TileTypeEnum[TileTypeEnum["River"] = 15] = "River";
	    TileTypeEnum[TileTypeEnum["Lake"] = 16] = "Lake";
	})(exports.TileTypeEnum || (exports.TileTypeEnum = {}));
	var TileTypeEnum = exports.TileTypeEnum;
	exports.TileColorDict = Immutable.Map((_Immutable$Map = {}, _defineProperty(_Immutable$Map, TileTypeEnum.Sea, '#363661'), _defineProperty(_Immutable$Map, TileTypeEnum.SubtropicalDesert, '#E9DDC7'), _defineProperty(_Immutable$Map, TileTypeEnum.Grassland, '#C4D4AA'), _defineProperty(_Immutable$Map, TileTypeEnum.TropicalSeasonalForest, '#A9CCA4'), _defineProperty(_Immutable$Map, TileTypeEnum.TropicalRainForest, '#9CBBA9'), _defineProperty(_Immutable$Map, TileTypeEnum.TemperateDesert, '#E4E8CA'), _defineProperty(_Immutable$Map, TileTypeEnum.TemperateDeciduousForest, '#B4C9A9'), _defineProperty(_Immutable$Map, TileTypeEnum.TemperateRainForest, '#A4C4A8'), _defineProperty(_Immutable$Map, TileTypeEnum.TropicalRainForest, '#9CBBA9'), _defineProperty(_Immutable$Map, TileTypeEnum.Shrubland, '#C4CCBB'), _defineProperty(_Immutable$Map, TileTypeEnum.Taiga, '#CCD4BB'), _defineProperty(_Immutable$Map, TileTypeEnum.Scorched, '#999999'), _defineProperty(_Immutable$Map, TileTypeEnum.Bare, '#BBBBBB'), _defineProperty(_Immutable$Map, TileTypeEnum.Tundra, '#DDDDBB'), _defineProperty(_Immutable$Map, TileTypeEnum.Snow, '#F8F8F8'), _defineProperty(_Immutable$Map, TileTypeEnum.River, '#2B5B87'), _defineProperty(_Immutable$Map, TileTypeEnum.Lake, '#557DA6'), _Immutable$Map));
	var WhittakerDiagram = [_.times(6, function (i) {
	    return TileTypeEnum.Sea;
	}), _.flatten([TileTypeEnum.SubtropicalDesert, TileTypeEnum.Grassland, _.times(2, function (i) {
	    return TileTypeEnum.TropicalSeasonalForest;
	}), _.times(2, function (i) {
	    return TileTypeEnum.TropicalRainForest;
	})]), _.flatten([TileTypeEnum.TemperateDesert, _.times(2, function (i) {
	    return TileTypeEnum.Grassland;
	}), _.times(2, function (i) {
	    return TileTypeEnum.TemperateDeciduousForest;
	}), TileTypeEnum.TemperateRainForest]), _.flatten([_.times(2, function (i) {
	    return TileTypeEnum.TemperateDesert;
	}), _.times(2, function (i) {
	    return TileTypeEnum.Shrubland;
	}), _.times(2, function (i) {
	    return TileTypeEnum.Taiga;
	})]), _.flatten([TileTypeEnum.Scorched, TileTypeEnum.Bare, TileTypeEnum.Tundra, _.times(4, function (i) {
	    return TileTypeEnum.Snow;
	})])];
	(function (PlantEnum) {
	    PlantEnum[PlantEnum["Tree"] = 0] = "Tree";
	    PlantEnum[PlantEnum["Cactus"] = 1] = "Cactus";
	    PlantEnum[PlantEnum["Algae"] = 2] = "Algae";
	})(exports.PlantEnum || (exports.PlantEnum = {}));
	var PlantEnum = exports.PlantEnum;
	exports.gen2dArr = function (w, h, iteratee) {
	    var rW = _.range(w),
	        rH = _.range(h);
	    return rH.map(function (y) {
	        return rW.map(function (x) {
	            return iteratee(x, y);
	        });
	    });
	};
	exports.dsInitCornerValues = function (arr) {
	    var lowerRandom = arguments.length <= 1 || arguments[1] === undefined ? 0 : arguments[1];
	    var upperRandom = arguments.length <= 2 || arguments[2] === undefined ? 256 : arguments[2];
	...
	exports.dsDiamondStep = function (arr) {
	    var startPoint = arguments.length <= 1 || arguments[1] === undefined ? [0, 0] : arguments[1];
	    var endPoint = arguments.length <= 2 || arguments[2] === undefined ? [arr.length - 1, arr.length - 1] : arguments[2];
	    var lowerRandom = arguments.length <= 3 || arguments[3] === undefined ? 0 : arguments[3];
	    var upperRandom = arguments.length <= 4 || arguments[4] === undefined ? 256 : arguments[4];

	    var _startPoint = _slicedToArray(startPoint, 2);

	    var startX = _startPoint[0];
	    var startY = _startPoint[1];
	    var _endPoint = _slicedToArray(endPoint, 2);

	    var endX = _endPoint[0];
	    var endY = _endPoint[1];var cornerNums = [arr[startX][startY], arr[endX][startY], arr[startX][endY], arr[endX][endY]];var centerX = (startX + endX) / 2;var centerY = (startY + endY) / 2;
	    arr[centerX][centerY] = _.mean(cornerNums) + _.random(lowerRandom, upperRandom, true);
	};
	exports.dsSquareStep = function (arr) {
	    var startPoint = arguments.length <= 1 || arguments[1] === undefined ? [0, 0] : arguments[1];
	    var endPoint = arguments.length <= 2 || arguments[2] === undefined ? [arr.length - 1, arr.length - 1] : arguments[2];
	    var lowerRandom = arguments.length <= 3 || arguments[3] === undefined ? 0 : arguments[3];
	    var upperRandom = arguments.length <= 4 || arguments[4] === undefined ? 256 : arguments[4];
	    ...
	    var startX = _startPoint2[0];
	    var startY = _startPoint2[1];
	    var _endPoint2 = _slicedToArray(endPoint, 2);

	    var endX = _endPoint2[0];
	    var endY = _endPoint2[1];var centerX = (startX + endX) / 2;var centerY = (startY + endY) / 2;
	    var centerVal = arr[centerX][centerY],
	    ...
	    if (arr[centerX][startY] === 0) {
	        arr[centerX][startY] = startY === 0 ? _.mean([centerVal, topLeftVal, topRightVal]) + randFun() : _.mean([centerVal, topLeftVal, topRightVal, arr[centerX][startY - distance]]) + randFun();
	    }
	    if (arr[endX][centerY] === 0) {
	        arr[endX][centerY] = endX === arr.length - 1 ? _.mean([centerVal, topRightVal, bottomRightVal]) + randFun() : _.mean([centerVal, topRightVal, bottomRightVal, arr[endX + distance][centerY]]) + randFun();
	    }
	    if (arr[centerX][endY] === 0) {
	        arr[centerX][endY] = endY === arr.length - 1 ? _.mean([centerVal, bottomLeftVal, bottomRightVal]) + randFun() : _.mean([centerVal, bottomLeftVal, bottomRightVal, arr[centerX][endY + distance]]) + randFun();
	    }
	    if (arr[startX][centerY] === 0) {
	        arr[startX][centerY] = startX === 0 ? _.mean([centerVal, topLeftVal, bottomLeftVal]) + randFun() : _.mean([centerVal, topLeftVal, bottomLeftVal, arr[startX - distance][centerY]]) + randFun();
	    }
	};
	var _dsDiamondAndSquare = function _dsDiamondAndSquare(arr) {
	    var startPoint = arguments.length <= 1 || arguments[1] === undefined ? [0, 0] : arguments[1];
	    var endPoint = arguments.length <= 2 || arguments[2] === undefined ? [arr.length - 1, arr.length - 1] : arguments[2];
	    var lowerRandom = arguments.length <= 3 || arguments[3] === undefined ? 0 : arguments[3];
	    var upperRandom = arguments.length <= 4 || arguments[4] === undefined ? 256 : arguments[4];
	    var insertAction = arguments.length <= 5 || arguments[5] === undefined ? null : arguments[5];

	    var _startPoint3 = _slicedToArray(startPoint, 2);

	    var startX = _startPoint3[0];
	    var startY = _startPoint3[1];
	    var _endPoint3 = _slicedToArray(endPoint, 2);

	    var endX = _endPoint3[0];
	    var endY = _endPoint3[1];var centerX = (startX + endX) / 2;var centerY = (startY + endY) / 2;var centerPoint = [centerX, centerY];
	    if (endX - startX <= 1) {
	        return;
	    }
	    var conti = void 0;
	    exports.dsDiamondStep(arr, startPoint, endPoint, lowerRandom, upperRandom);
	    if (insertAction != null) {
	        conti = insertAction();
	    }
	    exports.dsSquareStep(arr, startPoint, endPoint, lowerRandom, upperRandom);
	    // console.log("UpperRandom: " + upperRandom);
	    // connect the next level, also include the next next level
	    var nextCont = function nextCont() {
	        return _dsDiamondAndSquare(arr, startPoint, centerPoint, lowerRandom, upperRandom / 2, function () {
	            return _dsDiamondAndSquare(arr, [centerX, startY], [endX, centerY], lowerRandom, upperRandom / 2, function () {
	                return _dsDiamondAndSquare(arr, [startX, centerY], [centerX, endY], lowerRandom, upperRandom / 2, function () {
	...
	var utils_ts_1 = __webpack_require__(50);
	exports.dsDiamondAndSquare = function (arr) {
	    var startPoint = arguments.length <= 1 || arguments[1] === undefined ? [0, 0] : arguments[1];
	    var endPoint = arguments.length <= 2 || arguments[2] === undefined ? [arr.length - 1, arr.length - 1] : arguments[2];
	    var lowerRandom = arguments.length <= 3 || arguments[3] === undefined ? 0 : arguments[3];
	    var upperRandom = arguments.length <= 4 || arguments[4] === undefined ? 256 : arguments[4];
	    ...
	    var r = _dsDiamondAndSquare(arr, startPoint, endPoint, lowerRandom, upperRandom, insertAction);
	    utils_ts_1.trampoline(r);
	};
	exports.diamondSquare = function (n) {
	    if (n % 2 === 0) {
	    ...
	    var arr2d = exports.gen2dArr(n, n, _.constant(0));
	    exports.dsInitCornerValues(arr2d, 0, n - 1);
	    exports.dsDiamondAndSquare(arr2d, undefined, undefined, 0, n - 1);
	    return arr2d;
	};

	var Tile = function () {
	    function Tile(altitude, altitudePos) {
	    ...
	    _createClass(Tile, [{
	        key: 'getTileType',
	        value: function getTileType() {
	            return WhittakerDiagram[this.altitude][this.humidity];
	        }
	    }, {
	        key: 'getTileColor',
	        value: function getTileColor() {
	            return exports.TileColorDict.get(this.getTileType().toString());
	        }
	    }, {
	        key: 'getGrayLevelColor',
	        value: function getGrayLevelColor() {
	            var gl = (~ ~(this.altitudePos * 255)).toString(16);
	            return '#' + gl + gl + gl;
	        }
	    }]);
	...
	Tile.createWorld = function () {
	    var n = arguments.length <= 0 || arguments[0] === undefined ? 33 : arguments[0];
	    var landSizeRatio = arguments.length <= 1 || arguments[1] === undefined ? 0.65 : arguments[1];
	    var snowSizeRatio = arguments.length <= 2 || arguments[2] === undefined ? 0.02 : arguments[2];

	    var altitudeArr2d = exports.diamondSquare(n);
	    // console.log("Diamond Square: " + altitudeArr2d);
	    // (window as any).altitudeArr2d = _.flatten(altitudeArr2d);
	    var max = _.max(altitudeArr2d.map(function (arr) {
	        return _.max(arr);
	    })),
	        min = _.min(altitudeArr2d.map(function (arr) {
	        return _.min(arr);
	    }));
	    var altitudeSpan = max - min,
	        flatSort = _.flatten(altitudeArr2d).sort(function (a, b) {
	        return a - b;
	    }),
	        ...
	        climaticZoneSplitPoint = [coastlineAltitude].concat(_toConsumableArray(_.range(1, WhittakerDiagram.length - 2 + 1).map(function (i) {
	        return coastlineAltitude + normalClimaticZoneSpan * i;
	    })), [max]);
	    ...
	    return altitudeArr2d.map(function (altitudeArr) {
	        return altitudeArr.map(function (a) {
	            var altitudeLevel = _.findIndex(climaticZoneSplitPoint, function (point) {
	                return a <= point;
	            });
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.trampoline = function (f) {
	    if (_.isFunction(f)) {
	        var r = f();
	        if (r !== null) exports.trampoline(r);
	    }
	};
...
/***/ function(module, exports) {
	...
	var APPROXIMATE_PX_PER_TILE = 30;
	var cameraSize = Math.floor(Math.min(window.innerHeight, window.innerWidth) / APPROXIMATE_PX_PER_TILE);
	exports.CAMERA_SIZE = cameraSize % 2 === 0 ? cameraSize - 1 : cameraSize;
	exports.FINAL_TILE_EDGE_LENGTH_UNIT = window.innerHeight < window.innerWidth ? 'vh' : 'vw';
	exports.FINAL_TILE_EDGE_LENGTH = 100 / exports.CAMERA_SIZE + exports.FINAL_TILE_EDGE_LENGTH_UNIT;
	exports.MAP_EDGE_LENGTH = 33; // 2^n + 1
	exports.FRAME_IN_SECOND = 1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _compose = __webpack_require__(65);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__(60)(global || window || this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.ON_FRAME_ACTION = {
	    type: 'ON_FRAME'
	};
	exports.START_GAME_ACTION = {
	    type: 'START_GAME'
	};
	var constants_ts_1 = __webpack_require__(51);
	exports.lookAt = function (lookAtX, lookAtY) {
	    return function (dispatch, getState) {
	        var _getState = getState();

	        var mapCameraOffset = _getState.mapCameraOffset;
	        var tiles = _getState.tiles;
	        var _mapCameraOffset = _slicedToArray(mapCameraOffset, 2);

	        var x = _mapCameraOffset[0];
	        var y = _mapCameraOffset[1];var distance = Math.floor(constants_ts_1.CAMERA_SIZE / 2);var oX = lookAtX - distance;var oY = lookAtY - distance;var cX = Math.min(constants_ts_1.MAP_EDGE_LENGTH - constants_ts_1.CAMERA_SIZE, Math.max(0, oX));var cY = Math.min(constants_ts_1.MAP_EDGE_LENGTH - constants_ts_1.CAMERA_SIZE, Math.max(0, oY));
	        if (cX != x || cY != y) {
	            dispatch({
	                type: "OFFSET_CAMERA",
	                point: [cX, cY]
	...
	exports.onKeyPressed = function (key) {
	    return {
	        type: "KEY_PRESSED",
	        key: key
	    };
	};
	exports.appendMsg = function (msg) {
	    return {
	        type: "APPEND_MSG",
	        msg: msg
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(process) {var React = __webpack_require__(42);
	var ReactDOM = __webpack_require__(43);
	var ExecutionEnvironment = __webpack_require__(69);
	var ModalPortal = React.createFactory(__webpack_require__(70));
	var ariaAppHider = __webpack_require__(85);
	var elementClass = __webpack_require__(86);
	var renderSubtreeIntoContainer = __webpack_require__(43).unstable_renderSubtreeIntoContainer;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var focusManager = __webpack_require__(71);
	var scopeTab = __webpack_require__(73);
	var Assign = __webpack_require__(74);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var findTabbable = __webpack_require__(72);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 */
	var baseAssign = __webpack_require__(75),
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <https://lodash.com/license>
	 */
	var baseCopy = __webpack_require__(76),
	    keys = __webpack_require__(77);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <https://lodash.com/license>
	 */
	var bindCallback = __webpack_require__(82),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Keyboard = __webpack_require__(88);
	var Locale   = __webpack_require__(89);
	var KeyCombo = __webpack_require__(90);

	var keyboard = new Keyboard();

	keyboard.setLocale('us', __webpack_require__(91));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _translate = __webpack_require__(95);

	var _translate2 = _interopRequireDefault(_translate);

	var _interpolate = __webpack_require__(96);

	var _interpolate2 = _interopRequireDefault(_interpolate);

	var _I18nextProvider = __webpack_require__(97);

	var _I18nextProvider2 = _interopRequireDefault(_I18nextProvider);

	var _loadNamespaces = __webpack_require__(98);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Provider = __webpack_require__(100);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _hoistNonReactStatics = __webpack_require__(106);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var i18next = __webpack_require__(110);
	var XHR = __webpack_require__(126);
	var LanguageDetector = __webpack_require__(129);
	var inited = i18next.use(XHR).use(LanguageDetector).init({
	    "debug": false,
	    "load": "currentOnly",
	    "fallbackLng": "en",
	    "backend": {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _i18next = __webpack_require__(112);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _EventEmitter2 = __webpack_require__(114);

	var _EventEmitter3 = _interopRequireDefault(_EventEmitter2);

	var _ResourceStore = __webpack_require__(115);

	var _ResourceStore2 = _interopRequireDefault(_ResourceStore);

	var _Translator = __webpack_require__(117);

	var _Translator2 = _interopRequireDefault(_Translator);

	var _LanguageUtils = __webpack_require__(120);

	var _LanguageUtils2 = _interopRequireDefault(_LanguageUtils);

	var _PluralResolver = __webpack_require__(121);

	var _PluralResolver2 = _interopRequireDefault(_PluralResolver);

	var _Interpolator = __webpack_require__(122);

	var _Interpolator2 = _interopRequireDefault(_Interpolator);

	var _BackendConnector = __webpack_require__(123);

	var _BackendConnector2 = _interopRequireDefault(_BackendConnector);

	var _CacheConnector = __webpack_require__(124);

	var _CacheConnector2 = _interopRequireDefault(_CacheConnector);

	var _defaults2 = __webpack_require__(125);

	var _postProcessor = __webpack_require__(118);

	var _postProcessor2 = _interopRequireDefault(_postProcessor);

	var _v = __webpack_require__(119);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _navigator = __webpack_require__(135);

	var _navigator2 = _interopRequireDefault(_navigator);

	var _htmlTag = __webpack_require__(136);
